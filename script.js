    ...
    function validateField(field) {
      ...
      for (let i = 0; i < rules.length; i++) {
        ...
        if (validators[ruleName]) {
          const passed = validators[ruleName](field.value, ruleParam);
          if (!passed) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .then(function () {
          ...
          showFormFeedback(contactForm, successMsg, 'success');
          contactForm.reset();
          contactForm.querySelectorAll('.input-error').forEach(function (f) {
            clearError(f);
          });
        })
        .catch(function () {
          const errorMsg = contactForm.dataset.errorMessage || 'Something went wrong. Please try again.';
          showFormFeedback(contactForm, errorMsg, 'error');
        })
        .finally(function () {
          if (submitBtn) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '8222a594-adcf-466d-ad22-459cb3c50878',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '8222a594-adcf-466d-ad22-459cb3c50878';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '8222a594-adcf-466d-ad22-459cb3c50878';
